...
@NoArgsConstructor
@AllArgsConstructor
@TableName("T_CEEDATA_JIANGSU")
public class CEEDataJS implements Serializable {
    @TableId(value = "ID")
    ...
    @TableField("T_CEEDATA_COLLEGE_JIANGSU_ID")
    private String T_CEEDATA_COLLEGE_JIANGSU_ID;
