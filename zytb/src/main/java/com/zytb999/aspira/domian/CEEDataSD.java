...
@NoArgsConstructor
@AllArgsConstructor
@TableName("T_CEEDATA_SHANDONG")
public class CEEDataSD implements Serializable {
    @TableId(value = "ID")
    ...
    @TableField("T_CEEDATA_COLLEGE_SHANDONG_ID")
    private String T_CEEDATA_COLLEGE_SHANDONG_ID;
